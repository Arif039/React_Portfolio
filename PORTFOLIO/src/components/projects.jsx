        ...
        <div className='w-5/6 m-auto mt-20'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
                ...
                <div className='flex flex-col gap-4 border-1 border-gray-300  rounded-md shadow-md'>
                    ...
                    <button type='submit'  className='relative overflow-hidden group flex flex-row gap-4 border-1 rounded-lg ml-4 mb-4 w-3/7 md:w-3/7 text-sm  cursor-pointer text-violet-600 font-bold px-2 py-3 border-violet-600 hover:scale-105 transition-transform duration-300' onClick={() => window.open('https://arif039.github.io/simple_supply_chain/', '_blank')} >Case Study <img src={arrowImage} alt="arrowImage" className='transition-transform duration-300 ease-in-out group-hover:translate-x-3'/> </button>
                </div>
                ...
                <div className='flex flex-col gap-4 border-1 border-gray-300  rounded-md shadow-md'>
                    ...
                    <button className='relative overflow-hidden group flex flex-row gap-4 border-1 rounded-lg ml-4 mb-4 w-3/7 md:w-3/7 text-sm  cursor-pointer text-violet-600 font-bold px-2 py-3 border-violet-600 hover:scale-105 transition-transform duration-300'  onClick={() => window.open('https://arif039.github.io/Voting_dApp/', '_blank')}>Case Study <img src={arrowImage} alt="arrowImage" className='transition-transform duration-300 ease-in-out group-hover:translate-x-3'/> </button>
                </div>
                ...
                <div className='flex flex-col gap-4 border-1 border-gray-300  rounded-md shadow-md'>
                    ...
                    <button className='relative overflow-hidden group flex flex-row gap-4 border-1 rounded-lg ml-4 mb-4 w-3/7 md:w-3/7 text-sm  cursor-pointer text-violet-600 font-bold px-2 py-3 border-violet-600 hover:scale-105 transition-transform duration-300' onClick={() => window.open('https://arif039.github.io/todo-app/', '_blank')}>Case Study <img src={arrowImage} alt="arrowImage" className='transition-transform duration-300 ease-in-out group-hover:translate-x-3'/> </button>
                </div>
                ...
                <div className='flex flex-col gap-4 border-1 border-gray-300  rounded-md shadow-md'>
                    ...
                    <h3 className='text-sm  text-[#697484] px-4'>The core benefits of decentralization in a supply chain stem from distributing control and data across multiple participants rather than relying on a central authority.</h3>
                    <button className='relative overflow-hidden group flex flex-row gap-4 border-1 rounded-lg ml-4 mb-4 w-3/7 md:w-3/7 text-sm  cursor-pointer text-violet-600 font-bold px-2 py-3 border-violet-600 hover:scale-105 transition-transform duration-300' onClick={() => window.open('https://arif039.github.io/erc20_Token/', '_blank')}>Case Study <img src={arrowImage} alt="arrowImage" className='transition-transform duration-300 ease-in-out group-hover:translate-x-3'/> </button>
                </div>
                ...
                <div className='flex flex-col gap-4 border-1 border-gray-300  rounded-md shadow-md'>
                    ...
                    <button className='relative overflow-hidden group flex flex-row gap-4 border-1 rounded-lg ml-4 mb-4 w-3/7 md:w-3/7 text-sm  cursor-pointer text-violet-600 font-bold px-2 py-3 border-violet-600 hover:scale-105 transition-transform duration-300' onClick={() => window.open('https://arif039.github.io/decentralize_portfolio1/', '_blank')}>Case Study <img src={arrowImage} alt="arrowImage" className='transition-transform duration-300 ease-in-out group-hover:translate-x-3'/> </button>
                </div>
                ...
                <div className='flex flex-col gap-4 border-1 border-gray-300  rounded-md shadow-md'>
                    ...
                    <button className='relative overflow-hidden group flex flex-row gap-4 border-1 rounded-lg ml-4 mb-4 w-3/7 md:w-3/7 text-sm  cursor-pointer text-violet-600 font-bold px-2 py-3 border-violet-600 hover:scale-105 transition-transform duration-300' onClick={() => window.open('https://arif039.github.io/Multiplication-Table-Generator/', '_blank')}>Case Study <img src={arrowImage} alt="arrowImage" className='transition-transform duration-300 ease-in-out group-hover:translate-x-3'/> </button>
                </div>
